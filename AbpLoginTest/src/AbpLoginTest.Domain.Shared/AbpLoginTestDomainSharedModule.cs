...
public class AbpLoginTestDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AbpLoginTestGlobalFeatureConfigurator.Configure();
        AbpLoginTestModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AbpLoginTestDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AbpLoginTestResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AbpLoginTest");

            options.DefaultResourceType = typeof(AbpLoginTestResource);
        ...
        {
            options.MapCodeNamespace("AbpLoginTest", typeof(AbpLoginTestResource));
        });
    }
}
